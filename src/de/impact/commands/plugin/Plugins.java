...
public class Plugins extends Command {
    ...
    public void onChat(String[] aliases, Player p) {
        ...
        var installedPlugins = Bukkit.getPluginManager().getPlugins();
        var enabledPlugins = (int) Arrays.stream(installedPlugins).filter(Plugin::isEnabled).count();
