...
public class Help extends Command {
    ...
    private void sendClickableCategory(Player p) {
        ...
        List<BaseComponent> baseC = Arrays.stream(TextComponent.fromLegacyText(ChatUtils.getPluginPrefix())).collect(Collectors.toList());
    ...
    private void sendCommandsOfCategory(Player p, CommandCategory cat) {
        ...
        List<BaseComponent> cmdList = Arrays.stream(TextComponent.fromLegacyText(ChatUtils.getPluginPrefix())).collect(Collectors.toList());
