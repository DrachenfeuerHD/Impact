...
public class UserUtils {
    ...
    public static void login(UUID uuid) {
        ...
        for(var loggedIn : getLoggedInUsers()) {

            var loggedInPlayer = Bukkit.getPlayer(loggedIn);
        ...
        ChatUtils.sendMessage(p, "This is the free version of Impact. If you want more features be sure to buy the premium version");
    }
