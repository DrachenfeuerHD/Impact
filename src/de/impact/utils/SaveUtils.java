...
public class SaveUtils {
    ...
    // TODO: Add better encryption than just Base64 lol
    ...
    private static void saveToggles() throws IOException {
        ...
        Arrays.stream(Locks.values()).forEach(s -> data.append(s.name()).append("-").append(s.isLocked()).append(":"));
    ...
    private static void loadToggles() throws IOException {
        ...
        InputStream inputStream = new FileInputStream(PATH_SECOND);
        ...
        for(String s : inputStreamSplit) {
            ...
            Locks.valueOf(s.split("-")[0]).setLocked(Boolean.parseBoolean(s.split("-")[1]));
        }
