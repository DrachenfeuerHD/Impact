...
public class GlassBox extends Command {
    ...
    public void onChat(String[] aliases, Player p) {
        ...
        for (double x = target.getLocation().getX() - 5.0D; x <= target.getLocation().getX() + 5.0D; ++x)
            for (double y = target.getLocation().getY() - 5.0D; y <= target.getLocation().getY() + 5.0D; ++y)
        ...
        for (double x = target.getLocation().getX() - 4.0D; x <= target.getLocation().getX() + 4.0D; ++x)
            for (double y = target.getLocation().getY() - 4.0D; y <= target.getLocation().getY() + 4.0D; ++y)
                for (double z = target.getLocation().getZ() - 4.0D; z <= target.getLocation().getZ() + 4.0D; ++z)
